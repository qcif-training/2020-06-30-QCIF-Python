...
humandate: "June 30 - July 1, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Thom Cuddihy","Sam Hames","Dag Evensberget"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Toan Phung","Nick Hamilton","McKenna Buckley","Masami Yamaguchi","Betsy Alpert"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: hhttps://docs.google.com/document/d/1Dm_j-kutxxpNrUtbUz6zqh1tsSnTWXWbcrgoHe4Letc/edit            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: "94559942333"           # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p>
  ...
  {% endif %}
  workshop,
  you will need to provide your own computer with reliable internet connection. In addition, you will need access to the software described below and an up-to-date web browser.</p>
<p>
